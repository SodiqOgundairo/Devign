...
export interface TextStyleDef {
  name: string;       // e.g. "YemsUI/Heading/4XL"
...
export const TEXT_STYLE_DEFS: TextStyleDef[] = [
  // Display heading
  { name: "YemsUI/Heading/Display",   family: "Poppins", style: "Black",    size: 72, lineHeight: 80, letterSpacing: -2   },
  // Headings
  { name: "YemsUI/Heading/4XL",      family: "Poppins", style: "SemiBold", size: 48, lineHeight: 56, letterSpacing: -1.5 },
  { name: "YemsUI/Heading/3XL",      family: "Poppins", style: "SemiBold", size: 36, lineHeight: 44, letterSpacing: -1   },
  { name: "YemsUI/Heading/2XL",      family: "Poppins", style: "SemiBold", size: 30, lineHeight: 38, letterSpacing: -0.5 },
  { name: "YemsUI/Heading/XL",       family: "Poppins", style: "SemiBold", size: 24, lineHeight: 32, letterSpacing: -0.3 },
  { name: "YemsUI/Heading/LG",       family: "Poppins", style: "SemiBold", size: 20, lineHeight: 28, letterSpacing: -0.2 },
  { name: "YemsUI/Heading/MD",       family: "Poppins", style: "SemiBold", size: 18, lineHeight: 26, letterSpacing: -0.1 },
  // Body
  { name: "YemsUI/Body/XL",          family: "Poppins", style: "Regular",  size: 20, lineHeight: 32, letterSpacing: 0    },
  { name: "YemsUI/Body/LG",          family: "Poppins", style: "Regular",  size: 18, lineHeight: 28, letterSpacing: 0    },
  { name: "YemsUI/Body/MD",          family: "Poppins", style: "Regular",  size: 16, lineHeight: 24, letterSpacing: 0    },
  { name: "YemsUI/Body/SM",          family: "Poppins", style: "Regular",  size: 14, lineHeight: 22, letterSpacing: 0    },
  { name: "YemsUI/Body/XS",          family: "Poppins", style: "Regular",  size: 12, lineHeight: 18, letterSpacing: 0    },
  // Labels
  { name: "YemsUI/Label/LG",         family: "Poppins", style: "Medium",   size: 16, lineHeight: 24, letterSpacing: 0    },
  { name: "YemsUI/Label/MD",         family: "Poppins", style: "Medium",   size: 14, lineHeight: 20, letterSpacing: 0    },
  { name: "YemsUI/Label/SM",         family: "Poppins", style: "Medium",   size: 12, lineHeight: 16, letterSpacing: 0    },
  { name: "YemsUI/Label/XS",         family: "Poppins", style: "SemiBold", size: 10, lineHeight: 14, letterSpacing: 0.5  },
  // Code / Mono
  { name: "YemsUI/Code/MD",          family: "Fira Code", style: "Regular", size: 14, lineHeight: 22, letterSpacing: -0.2 },
  { name: "YemsUI/Code/SM",          family: "Fira Code", style: "Regular", size: 12, lineHeight: 18, letterSpacing: -0.1 },
  // Overline / caption
  { name: "YemsUI/Overline",         family: "Poppins", style: "SemiBold", size: 10, lineHeight: 14, letterSpacing: 1.5  },
  { name: "YemsUI/Caption",          family: "Poppins", style: "Regular",  size: 11, lineHeight: 16, letterSpacing: 0.2  },
];
...
export const EFFECT_STYLE_DEFS: EffectStyleDef[] = [
  ...
  {
    name: "YemsUI/Shadow/Primary Glow",
    effects: [
      {
  ...
  {
    name: "YemsUI/Shadow/Accent Glow",
    effects: [
      {
